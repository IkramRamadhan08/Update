...
import androidx.leanback.leanbackshowcase.app.details.DetailViewExampleWithVideoBackgroundFragment;
        ...
        setOnItemViewClickedListener(new OnItemViewClickedListener() {
            ...
            public void onItemClicked(Presenter.ViewHolder viewHolder, Object item, RowPresenter.ViewHolder viewHolder1, Row row) {
                ...
                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity(),
                        imageView, DetailViewExampleWithVideoBackgroundFragment.TRANSITION_NAME).toBundle();
                Intent intent = new Intent(getActivity().getBaseContext(),
                        DetailViewExampleWithVideoBackgroundActivity.class);
                Card card = (Card) item;
                int imageResId = card.getLocalImageResourceId(getContext());
                intent.putExtra(DetailViewExampleWithVideoBackgroundFragment.EXTRA_CARD, imageResId);
